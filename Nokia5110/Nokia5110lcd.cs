...
namespace Nokia.LCDScreens
{
    ...
    public class Nokia_5110
    {
        ...
        public Nokia_5110(bool useBacklight, Cpu.Pin CE, Cpu.PWMChannel backlight,
            Cpu.Pin reset, Cpu.Pin dataCommand)
        {
            if (useBacklight)
               this.backlight = new PWM(backlight, 2000, 100,true);
        ...
        private void Initialize()
        {
            ...
            spi.Write(new byte[]
              { 0x21, // LCD Extended Commands.
                ...
                0x0C, // LCD in normal mode.  0x0D for inverse, 0x0C for normal
